...
const Metaballs = () => {
  ...
  return (
    <div className="flex items-center justify-center absolute inset-0 w-screen h-screen bg-black">
      <span className="font-alatsi text-white text-[10vw]">METABALLS</span>
